...
Creative software studio. AI-augmented tools for music, games, film, and language.
...
Built by [Joshua Ayson](https://joshuaayson.com). All projects developed with AI collaboration using agent mode.

Read [AgentSpek](https://joshuaayson.com/books/agentspek/) — a guide to building with AI.

See all projects at [joshuaayson.com/projects](https://joshuaayson.com/projects/).
